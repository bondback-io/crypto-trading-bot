  ...
  return `
      ...
      <article class="botinfo-card" id="botinfo-sec-scanners" data-botinfo-section="scanners">
        ...
        <ul>
          ...
          <li><strong>High-MC majors / Steady inventory</strong> — Jupiter multi-feed (≥$20M medium / ≥$200M majors) → Dip/Steady watches. Pump.fun prioritized (~55% CYCLE seats; ≥7d age); non-pump secondary (≥30d). Vol/liq/movement filters + dead-tape / no-levels rotate. On reclaim, Soft/Steady share via lane fight; never Scalper Mode B.</li>
