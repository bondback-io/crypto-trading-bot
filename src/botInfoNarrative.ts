  ...
  return `
      ...
      <article class="botinfo-card" id="botinfo-sec-copy" data-botinfo-section="copy">
        ...
        <ul>
          ...
          <li><strong>Influencer Mirror</strong> (default OFF) — Add Wallet (GMGN enrich) + Import top 15 (30d PnL, GMGN primary) + Jupiter influencers (fail-soft). Soft Gatekeeper on copy buys; mirror-sell preferred vs PPP; Watch-tab Smart Mirror Watchlist (top 10 × 3 tokens, cross-hold +N, Add token). Copy size = profile risk sizing × wallet sizeMult — never influencer notional. Requires <code>smart_money_copy</code> + <code>smart_money_mirror</code>. Anti-rug / hard honeypot absolute.</li>
