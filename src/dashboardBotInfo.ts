      ...
      <div class="card" style="padding:1rem 1.1rem 0.5rem">
        <div class="botinfo-hero">
          <div>
            ...
            <p class="botinfo-lede">Operator manual for this dashboard — ${snap.counts.profiles} micro-bots, ${snap.counts.modules} modules, ${snap.counts.presets} presets. v1.2.425 applies upgrades in-process (no Render restart) and keeps 4-Lane RPC keys exclusive. Lists sync from code catalogs; use chips to jump.</p>
