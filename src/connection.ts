...
export function startRpcHealthMonitor(): void {
  ...
  /** Probe only preferred/active lanes — never unused fallbacks on the list. */
  ...
  console.log(
    `[rpc] Health monitor started (every ${interval}ms; preferred/active lanes only) — endpoints: ` +
